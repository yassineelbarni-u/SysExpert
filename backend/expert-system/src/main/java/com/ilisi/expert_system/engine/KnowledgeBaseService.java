...
/**
 * Base de connaissances du système expert : contient toutes les règles d'inférence.
 */
@Service
public class KnowledgeBaseService {

    public List<Rule> createKnowledgeBase() {
        ...
        // Scalabilité Horizontale pour Monolithique haute charge
        rules.add(new Rule(
        ...
        rules.add(new Rule(
                ...
                Map.of("taille_equipe", "petite",
                        "complexite_metier", List.of("faible", "moyenne")),
        ...
        rules.add(new Rule(
                "R_Tech_Python_Data",
                Map.of("type_application", List.of("data-processing", "iot")),
        ...
        rules.add(new Rule(
                "R7_Cloud_Public",
                Map.of("scalabilite", "critique",
                        "disponibilite", "haute",
                        "budget", List.of("moyen", "élevé")),
        ...
        // Taille serveur pour charge faible
        rules.add(new Rule(
        ...
        // Taille serveur pour charge moyenne
        rules.add(new Rule(
        ...
        rules.add(new Rule(
                ...
                "Docker recommandé même pour monolithique si deploiements fréquents",
                6
        ));

        // CI/CD pour déploiements fréquents
        rules.add(new Rule(
                "R16_CICD_DevOps",
        ...
        rules.add(new Rule(
                ...
                Map.of("structure_donnees", List.of("non-structurée", "semi-structurée"),
                        "scalabilite", "critique"),
        ...
        rules.add(new Rule(
                "R13_Redis_Cache",
                Map.of("charge_utilisateurs", List.of("moyenne", "élevée")),
        ...
        // Monitoring pour production haute disponibilité
        rules.add(new Rule(
                "R_Monitoring_Production",
                Map.of("disponibilite", List.of("haute", "critique")),
